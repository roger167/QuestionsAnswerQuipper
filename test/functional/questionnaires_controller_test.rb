...
class QuestionnairesControllerTest < ActionController::TestCase
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post :create, questionnaire: { answer: @questionnaire.answer, eval: @questionnaire.eval, idquestion: @questionnaire.idquestion }
    end
  ...
  test "should update questionnaire" do
    put :update, id: @questionnaire, questionnaire: { answer: @questionnaire.answer, eval: @questionnaire.eval, idquestion: @questionnaire.idquestion }
    assert_redirected_to questionnaire_path(assigns(:questionnaire))
  end
